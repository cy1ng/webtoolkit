...
public class TrackerClient1
{
  protected TrackerGroup trackerGroup;
  protected byte errno;
  private ClientConfig config;
  
	public TrackerClient1(TrackerGroup trackerGroup)
	{
		this.trackerGroup = trackerGroup;
	}

	
	public TrackerClient1() {
	...
	*/
	...
	public StorageServer getStoreStorage(Socket trackerSocket, String group_name) throws IOException
	{
		...
		try
		{
			...
			if (pkgInfo.errno != 0)
			{
				System.out.println("从tracker获取storage错误 ：errno=" +errno);
				return null;
			}
			...
			System.out.println("从tracker获取的storage ip: "+ip_addr+" , "+"port :" + port);
